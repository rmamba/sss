...
class TestInitCommandWithRestrectedAccess(unittest.TestCase):
  ...
  def test_05_full_init_no_guid_rights(self):
  ...
  def test_06_full_init_wrong_domain(self):
  ...
  def test_07_full_init_correct_domain_access_denied(self):
  ...
  def test_08_full_init_existing_domain(self):
  ...
  def test_09_full_init_correct_domain(self):
